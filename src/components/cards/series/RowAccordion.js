  ...
  return (
    <div className={show ? "active accordion" : "close"}>
      ...
      <div className="accordion-end">
          <div className="last-section"><img src={group} alt="accordion-end"/> <a className="more-btn">Daha çox</a></div>
          <div className="last-section-btn"><button className='send-notification-btn'>bildiriş göndər</button></div>
      </div>
    </div>
  );
}
