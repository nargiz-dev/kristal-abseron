    ...
    <div className="cards-wrapper">
      {Object.keys(grouppedBuildings).map((key) => (
        <div className="card-groups">
          <h3>{key}</h3>
          {grouppedBuildings[key].map((building) => (
            <div className="card-container">
              <div className="different-color">
                <div className="building-category" style={HeaderColor(building.kateqoriya)}>
                ...
                <div className="room-number">
                  ...
                  <span style={spanColor(building.kateqoriya)}>{building.otaqsayi}</span>
                </div>
              </div>
